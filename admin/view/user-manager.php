<?php
  ...
  $result = $conn->query("SELECT * FROM users WHERE role = 0");
?>
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div  style="margin-bottom: 10px;">
			<button class="btn btn-success" data-toggle="modal" data-target="#ModalRegister1"><span class="glyphicon glyphicon-plus" ></span> Thêm người dùng</button>
		</div>
				...
				?>
						<tr>
							...
							<td style="text-align: center;">
								<button class="btn btn-warning"><span class="glyphicon glyphicon-pencil" onclick="if( confirm('khi sửa thông tin phải nhập lại mật khẩu!'))window.location.href='?thread=edit-user&id-user=<?php echo $row['id'];  ?>'"></span> </button>
								<button class="btn btn-danger"><span class="glyphicon glyphicon-trash" onclick="if( confirm('Bạn có chắc chắn muốn xoá không!'))window.location.href='?thread=delete-user&id-user=<?php echo $row['id'];  ?>'"></span> </button>
							</td>
						</tr>
				<?php
					}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="?thread=add-user" method="POST" onsubmit=" return CheckData(this)">
